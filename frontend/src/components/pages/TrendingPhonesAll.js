...
function TrendingPhonesAll() {
  ...
  return (
    <div className="container category">
      <MetaData title="Trending Phones" />
      <h3 className="badge rounded-pill bg-danger topic">Trending Phones</h3>
...
export default TrendingPhonesAll;
